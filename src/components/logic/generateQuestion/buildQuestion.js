import { skill as mySkill } from "./data";

//---> function that builds the question based on the operator and skill stage
const buildQuestion = (operator, currentSkill, levelCode) => {
  const skill = mySkill(levelCode);
  ...
  if (a <= 0 || q1 === 0 || q2 === 0) {
    ...
    return buildQuestion(operator, currentSkill, levelCode);
  }
