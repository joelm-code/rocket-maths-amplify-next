...
import { Flex, useColorModeValue, HStack, VStack, Text, Spacer, Fade, Progress, Switch, Collapse, useDisclosure, Button, Badge, useBoolean, SlideFade, useMediaQuery } from "@chakra-ui/react";
          ...
          {!levelCleared && (
            <VStack>
              ...
              <HStack rounded={"lg"} bg={"whiteAlpha.700"} boxShadow={"lg"} minW={"60"} p={3}>
                ...
                <Timer minutes={minutes} seconds={seconds - 1} totalTime={totalTime} />
              </HStack>
